 ...
 * @author Renato
 */
public class ProbarSelenium {

    @Before
    public void testBefore() {
        // docker pull nginx:1.15.5-alpine
        // docker run --rm -p 80:80 -d -v "c:\\TEMP\\www\":/usr/share/nginx/html:ro nginx:1.15.5-alpine
    }
    ...
    public void test01() throws InterruptedException {
        ...
        chromeExecutor.get("http://www.google.com");        
    ...
    public void test02() throws InterruptedException {
        File file = new File("phantomjs-2.1.1-windows\\bin\\phantomjs.exe");
        System.setProperty("phantomjs.binary.path", file.getAbsolutePath());

        WebDriver phamJSExecutor = new PhantomJSDriver();

        phamJSExecutor.get("http://localhost/calidad/");
